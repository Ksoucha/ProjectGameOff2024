...
## Game Overview
Developed with Unreal Engine 5, in 3D, where you can alternate between first-person and top-down view. In collaboration with 9 people listed here -> [Steambound](https://doumeki21.itch.io/steambound)
...
Check out the gameplay trailer here -> [Steambound trailer](https://www.youtube.com/watch?v=XFD5B-sBY9E)
...
* Different spell attributes (Elements/Speed/Size/Shape) contribute to different speed, HP and attack power 
...
* The enemies shoot at their own allies, and need shape cast to test whether if it is okay to shoot
...
* Different units should have different HP and mana regeneration (not balanced yet)
* Create create a class system so that the player can start with different unlocked spells attributes
